...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of Ex of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} Ex` The number of Ex in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, Ex ) {
